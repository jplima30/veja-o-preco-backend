...
PASTA_FILTRADA = os.path.join(BASE_DIR, "TRIAGEM_LOCAL")
...
def iniciar_triagem(janela=None, data_teste=None):
    ...
    print(f"\n🔍 [TRIAGEM LOCAL] Iniciando processamento da janela: {contexto}")
    ...
    print("\n" + "="*60)
    print("🧠 TRIAGEM LOCAL v3.0 (FOCO EM PREÇO)")
    print("="*60)
    ...
    print("\n" + "="*60)
    print("🏁 TRIAGEM LOCAL FINALIZADA!")
...
if __name__ == "__main__":
    ...
    # Ou data completa para teste: python3 triagem_local.py test 2026-04-29_Quarta/manual
